...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3440.499821393236; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3673.5347627417486; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2657.5484057908125; // x position of the perpendicular encoder (in tick units)
    }
